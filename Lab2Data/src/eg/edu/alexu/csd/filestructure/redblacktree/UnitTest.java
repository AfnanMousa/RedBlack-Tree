...
//                RBTreePrinter xy=new RBTreePrinter();
//                xy.print(redBlackTree.getRoot());
//                System.out.println();
    ...
    public void testDeleteRandomElementsInTree() {
        ...
        try {
            ...
            for (Integer elem=0; elem<arr.length-1;elem++){
                System.out.println(elem);
                System.out.println(arr[elem]);
                Assert.assertTrue(redBlackTree.delete((int)arr[elem]));
//                RBTreePrinter xy=new RBTreePrinter();
//                xy.print(redBlackTree.getRoot());
//                System.out.println();
            }
            System.out.println(arr[arr.length-1]);
            Assert.assertTrue(redBlackTree.delete((int)arr[arr.length-1]));
            RBTreePrinter xy=new RBTreePrinter();
            xy.print(redBlackTree.getRoot());
            System.out.println();
            INode<Integer, String> node = redBlackTree.getRoot();
    ...
    public void testHeadMap() {
        ...
        try {
            ...
            for (int i = 0; i < 10000; i++) {//10000
                int key = r.nextInt(1000000);//1000000
                String val = "" + r.nextInt(10000);
                treemap.put(key, val);
                t.put(key, val);
                keys.add(key);
